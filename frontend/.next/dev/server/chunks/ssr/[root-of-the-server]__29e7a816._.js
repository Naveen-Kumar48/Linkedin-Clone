...
"[project]/src/config/index.js [ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/src/config/index.js'\n\nExpression expected");
...
const postSlice = (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$reduxjs$2f$toolkit__$5b$external$5d$__$2840$reduxjs$2f$toolkit$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$29$__["createSlice"])({
    ...
    extraReducers: (builder)=>{
        builder.addCase(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$redux$2f$action$2f$postAction$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["getAllPost"].pending, (state)=>{
            ...
            state.isLoading = false, state.isError = false, state.postFetched = true, state.posts = action.payload.posts, state.message = "Posts fetched successfully";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__29e7a816._.js.map
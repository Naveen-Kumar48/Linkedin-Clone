...
"[externals]/next/dist/server/require-hook [external] (next/dist/server/require-hook, cjs)", ((__turbopack_context__, module, exports) => {

const mod = __turbopack_context__.x("next/dist/server/require-hook", () => require("next/dist/server/require-hook"));

module.exports = mod;
}),
"[project]/src/pages/my_connections/index.jsx [ssr] (ecmascript)", (() => {{

throw new Error("An error occurred while generating the chunk item [project]/src/pages/my_connections/index.jsx [ssr] (ecmascript)\n\nCaused by:\n- CJS module can't be async.\n\nDebug info:\n- An error occurred while generating the chunk item [project]/src/pages/my_connections/index.jsx [ssr] (ecmascript)\n- Execution of <ModuleChunkItem as EcmascriptChunkItem>::content_with_async_module_info failed\n- Execution of EcmascriptChunkItemContent::new failed\n- CJS module can't be async.");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__619efcfe._.js.map
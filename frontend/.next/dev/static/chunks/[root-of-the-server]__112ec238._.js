...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/router.js [client] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module '../../config/redux/reducer'");
...
function DashboardLayout(t0) {
    ...
    if ($[0] !== "1073537bb23081b219088a4d194da31a9178f2d5ae8508876655f0f0435b5c4e") {
        for(let $i = 0; $i < 31; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1073537bb23081b219088a4d194da31a9178f2d5ae8508876655f0f0435b5c4e";
    }
    const { children } = t0;
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])();
    let t1;
...
function Dashboard() {
    ...
    if ($[0] !== "3070493b772a4e829a192e64d80cdb2b38d194a265b8ad4f6fd4a0f40ef00063") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3070493b772a4e829a192e64d80cdb2b38d194a265b8ad4f6fd4a0f40ef00063";
    }
    ...
    let t0;
    if ($[1] !== authState.isTokenThere || $[2] !== dispatch) {
        t0 = ({
            "Dashboard[useEffect()]": ()=>{
    ...
    let t1;
    if ($[4] !== authState.isTokenThere) {
        t1 = [
            authState.isTokenThere
        ];
        $[4] = authState.isTokenThere;
        $[5] = t1;
    } else {
        t1 = $[5];
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__112ec238._.js.map
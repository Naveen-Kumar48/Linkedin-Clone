...
function DashboardLayout(t0) {
    ...
    if ($[0] !== "84853bf44b2928acfc61c2702de0aa5f0687273419c1ac366119bfac489900b1") {
        for(let $i = 0; $i < 39; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "84853bf44b2928acfc61c2702de0aa5f0687273419c1ac366119bfac489900b1";
    }
    const { children } = t0;
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])();
...
function DiscoverPage() {
    ...
    if ($[0] !== "38d124c1c1bf91942aef2e53d0b5601632f4a28f22b136221543eea32a6493f6") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "38d124c1c1bf91942aef2e53d0b5601632f4a28f22b136221543eea32a6493f6";
    }
    const dispatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useDispatch"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4247a4cf._.js.map
...
function Dashboard() {
  ...
  const handleDeletePost = async (postId) => {
    await dispatch(deletePost({ postId, token: localStorage.getItem("token") }))
    dispatch(getAllPost())
  }
                  ...
                  return (
                    <div key={post._id} className={styles.singleCard}>
                      <div className={styles.cardHeader}>
                        ...
                        {authState.user.userId._id === post.userId._id && <div onClick={() => handleDeletePost(post._id)} className={styles.deleteButton}>
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
